...
DataIngestionMetadataInfo = namedtuple("DataIngestionMetadataInfo", ["from_data","to_date","data_file_path"])
...
class DataIngestionMetadata:
    ...
    def wite_metadata_info(self, from_date:str, to_date: str, data_file_path: str):
        try:
